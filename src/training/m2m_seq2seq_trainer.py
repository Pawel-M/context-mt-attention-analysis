...
from transformers import Seq2SeqTrainer, LogitsProcessor, LogitsProcessorList
...
class M2MSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def prediction_step(
        ...
        generated_tokens = self.model.generate(
            generation_inputs,
            # forced_bos_token_id=forced_bos_token_ids[0],
    ...
    def _remove_unused_columns(self, dataset: "datasets.Dataset", description: Optional[str] = None):
        # Remove the code that ignores unused columns to try to keep the forced bos token id
        return dataset
